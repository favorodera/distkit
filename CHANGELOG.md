...
[compare changes](https://github.com/favorodera/distkit/compare/v0.1.0...v1.0.0)
...
- **registry:** Add shared dependencies ([5fd391c](https://github.com/favorodera/distkit/commit/5fd391c))

  - Define global npm and utility dependencies
  - Enable shared dependency resolution
...
- **playground:** Add playground workspace package ([6828f40](https://github.com/favorodera/distkit/commit/6828f40))

  - Add playground app to test distkit logics
  - Track playground workspace in git
...
- **release:** Quote package filter in bump hook ([f11932b](https://github.com/favorodera/distkit/commit/f11932b))

  - Prevent shell parsing issues with scoped package
...
- **readme:** Simplify version badge label ([89be48f](https://github.com/favorodera/distkit/commit/89be48f))

  - Update NPM Version badge text to Version
...
- **vscode:** Recommend errorlens extension ([b75296b](https://github.com/favorodera/distkit/commit/b75296b))
- **ci:** Skip package publishing in release workflow ([dbfe201](https://github.com/favorodera/distkit/commit/dbfe201))
- **config:** Quote package path in git hook ([f96ca45](https://github.com/favorodera/distkit/commit/f96ca45))

  - Support directories with spaces in path name

- **cli:** Log parsed registry on init ([2d0f6bb](https://github.com/favorodera/distkit/commit/2d0f6bb))
- **ci:** Enable package publishing in release workflow ([60aaa81](https://github.com/favorodera/distkit/commit/60aaa81))
- **ci:** Prevent publishing during release ([dc95f35](https://github.com/favorodera/distkit/commit/dc95f35))

  - Add --no-publish flag to Relizy release step
